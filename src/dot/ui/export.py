...
def export_session_html(
    ...
    filename = f"dot-session-{export_session_id}.html"
...
<title>dot v{html.escape(safe_version)} - {html.escape(export_session_id)}</title>
<style>
...
<body>
<div class="header">
<h1>dot v{html.escape(safe_version)}</h1>
